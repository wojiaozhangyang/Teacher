...
public class TData_fuben {
	...
	public TData_fuben(String num, String sid, String nodeidd, String subtype, String datavalue, Timestamp dtime,
			String mac, String encryptionflag, String data, String retention1, String retention2) {
		super();
		this.num = num;
		this.sid = sid;
	...
	public String toString() {
		return "TData_fuben [num=" + num + ", sid=" + sid + ", nodeidd=" + nodeidd + ", subtype=" + subtype
				+ ", datavalue=" + datavalue + ", dtime=" + dtime + ", mac=" + mac + ", encryptionflag="
				+ encryptionflag + ", data=" + data + ", retention1=" + retention1 + ", retention2=" + retention2 + "]";
	}
